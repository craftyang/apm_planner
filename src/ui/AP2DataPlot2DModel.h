...
public:
    ...
    void addType(QString name,QStringList types,QStringList names);
...
private:
    ...
    QString makeCreateTableString(QString tablename, QStringList formatstr,QStringList variablestr);
